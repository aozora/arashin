...
//   css.addFile('admin_core', __dirname + '/../admin/public/css/flat-ui.css');
   ...
   // admin css
   css.addFile('admin_dashboard', __dirname + '/../admin/public/css/admin.less');
   ...
   js.addFile('admin_core', __dirname + '/../admin/public/js/jquery-2.0.3.js');
...
//   js.addFile('admin_core', __dirname + '/../admin/public/js/flatui-radio.js');
   js.addFile('admin_core', __dirname + '/../admin/public/js/holder.js');
...
//   js.addFile('admin_dashboard',  __dirname + '/../admin/public/js/gnmenu.js');
   js.addFile('admin_dashboard',  __dirname + '/../admin/public/js/toggles.js');
